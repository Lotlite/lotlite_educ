...
function App() {
  ...
  return (
    <div className="flex h-screen bg-white overflow-hidden relative selection:bg-wine/10 selection:text-black">
      ...
      <div className={`fixed inset-0 z-50 md:hidden flex transition-all duration-300 ${isMobileMenuOpen ? 'pointer-events-auto opacity-100' : 'pointer-events-none opacity-0'}`}>
        {/* Backdrop */}
        <div 
        ...
        {/* Sliding panel */}
        <aside 
          className={`relative w-64 bg-white shadow-2xl h-full flex flex-col transition-transform duration-300 ease-out z-10 ${
