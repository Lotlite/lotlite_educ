        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-20" data-aos="fade-up">
          ...
          <div data-aos="fade-up" data-aos-delay="300">
            ...
            <div className="flex flex-wrap justify-center gap-3 mb-6">
              {[
                { icon: <Linkedin size={18} />, href: "https://www.linkedin.com/company/lotlite-startup" },
                { icon: <Instagram size={18} />, href: "https://www.instagram.com/lotlite.program/?hl=en" },
                { icon: <Facebook size={18} />, href: "https://www.facebook.com/profile.php?id=61590811890916" },
                { icon: <Youtube size={18} />, href: "https://m.youtube.com/@Lottliteschoolofrealestate" },
                { icon: <XIcon size={18} />, href: "https://x.com/LotliteProgram" },
                { icon: <ThreadsIcon size={18} />, href: "https://www.threads.com/@lotlite.program" },
