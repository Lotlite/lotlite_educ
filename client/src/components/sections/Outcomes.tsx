      ...
      <div className="grid md:grid-cols-2 min-h-[800px]">
        ...
        <div className="relative p-12 md:p-24 flex flex-col justify-center overflow-hidden">
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-20" data-aos="fade-up">
            ...
            <button className="border-2 border-black/20 dark:border-white/20 text-black dark:text-white px-6 md:px-8 py-3 md:py-4 rounded-lg font-bold hover:bg-wine hover:text-white hover:border-wine transition-all text-sm uppercase tracking-widest">
              Download Report ⤓
            </button>
          </div>

          <div className="pt-8 border-t border-black/5 dark:border-white/10" data-aos="fade-up">
            <p className="text-black/30 dark:text-zinc-500 text-[10px] uppercase tracking-[0.3em] mb-6 font-bold">Leading Placement</p>
            <div className="bg-white dark:bg-zinc-900 border border-wine/10 dark:border-white/10 p-6 rounded-2xl flex items-center gap-6 shadow-sm group hover:border-wine/40 dark:hover:border-wine/40 transition-all">
              <div className="w-16 h-16 rounded-full bg-offwhite dark:bg-zinc-800 border border-black/10 dark:border-white/10 flex items-center justify-center text-wine font-bold text-xl shadow-inner shrink-0">
                AA
              </div>
              <div className="flex flex-col">
                <h4 className="text-xl font-bold text-black dark:text-white group-hover:text-wine dark:group-hover:text-wine transition-colors">Ankit Agrawal</h4>
                ...
                <div className="flex flex-wrap gap-2">
                  {['CBRE', 'Lodha', 'JLL'].map(comp => (
                    <span key={comp} className="px-2 py-0.5 border border-border dark:border-white/10 bg-offwhite dark:bg-zinc-800 rounded text-[8px] font-bold uppercase text-muted dark:text-zinc-300 tracking-widest">
                      {comp}
                    </span>
                  ))}
                </div>
        ...
        <div className="p-12 md:p-24 bg-transparent flex flex-col justify-center relative overflow-hidden border-l border-black/5 dark:border-white/10">
          <div className="mb-12" data-aos="fade-up">
            <span className="text-wine text-[10px] font-bold uppercase tracking-[0.3em] block mb-4">ALUMNI OUTCOMES</span>
            <h2 className="text-4xl md:text-5xl text-black dark:text-white font-serif leading-tight mb-6">At the Forefront of Indian Real Estate</h2>
            <p className="text-black/50 dark:text-zinc-300 leading-relaxed font-medium">
          ...
          <div className="relative h-[340px]">
            <AnimatePresence mode="wait">
              <motion.div
                ...
                className="absolute inset-0 bg-white dark:bg-zinc-900 border border-black/5 dark:border-white/10 rounded-2xl shadow-2xl p-10 flex flex-col items-center text-center justify-center group"
              >
                <div className="w-24 h-24 rounded-full bg-offwhite dark:bg-zinc-800 border border-black/10 dark:border-white/10 flex items-center justify-center text-wine font-bold text-3xl mb-6 shadow-inner relative">
                ...
                <h3 className="text-2xl font-bold text-black dark:text-white mb-2 tracking-tight">{alumni[currentIndex].name}</h3>
                ...
                <div className="w-12 h-px bg-black/10 dark:bg-white/10 my-4" />
                <p className="text-black/30 dark:text-zinc-400 text-[10px] uppercase tracking-[0.3em] font-bold">Batch of {alumni[currentIndex].batch}</p>
              </motion.div>
            </AnimatePresence>
          </div>
