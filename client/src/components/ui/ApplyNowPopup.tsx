...
import { X, Phone, User, ArrowRight, Mail, GraduationCap } from 'lucide-react';
...
export default function ApplyNowPopup({ isOpen, onClose }: ApplyNowPopupProps) {
          ...
          >
            <div className="bg-white dark:bg-zinc-900 rounded-2xl shadow-2xl overflow-hidden border border-border dark:border-white/10 relative">
              ...
              <div className="bg-wine p-6 text-center relative">
                ...
                >
                  <GraduationCap size={24} className="true-text-white" />
                </div>
                <h3 className="text-2xl font-serif font-bold true-text-white">Start Your Application</h3>
                <p className="text-sm true-text-white opacity-80 mt-1">Take the first step towards your real estate career</p>
              </div>
              ...
              <div className="p-6 min-h-[280px] flex flex-col justify-center">
                {isSuccess ? (
                  ...
                  >
                    ...
                    <h4 className="text-xl font-bold dark:text-white mb-2">Application Received!</h4>
                    <p className="text-muted text-sm">We've received your application. Our admissions team will reach out to you shortly.</p>
                  </motion.div>
                ) : (
